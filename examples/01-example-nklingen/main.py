...
def main(
    ...
    # Import csv dataset from Dataloader.py and create dataloader to pytorch
    train_dataset = SensorDataset(csv_name = train_csv,
                                  root_dir = "Data/",
    ...
    train_dataloader = DataLoader(train_dataset,
                                  batch_size=1,
                                  shuffle=True)
    test_dataset = SensorDataset(csv_name = test_csv,
                                 root_dir = "Data/",
                                 training_length = training_length,
                                 forecast_window = forecast_window)
    ...
    best_model = transformer(train_dataloader,
                             epoch,
                             #k,
                             frequency,
                             path_to_save_model,
    ...
    inference(path_to_save_predictions,
              forecast_window,
              test_dataloader,
              device,
              path_to_save_model,
