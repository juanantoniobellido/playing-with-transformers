...
class Transformer(nn.Module):
    ...
    def __init__(self,feature_size=7, num_layers=3, dropout=0):
        ...
        # En otro que he visto sí que tiene un decoder
        # self.decode_layer = nn.TransformerEncoderLayer(d_model=256, nhead=7, dropout=dropout)
        # self.transformer_decoder = nn.TransformerEncoder(self.decode_layer, num_layers=num_layers)
